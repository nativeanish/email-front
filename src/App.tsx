  ...
  const [emails] = useState<Email[]>([
    {
      ...
      preview: 'Hi John, I hope this message finds you well! I\'m reaching out to explore...',
    ...
    },
    {
      ...
      preview: 'Hi John, Thank you for attending the product demonstration yesterday...',
      date: '9:00',
      read: true,
    },
  ]);
  ...
  return (
    <div className={`flex h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="flex-1 flex flex-col w-full md:w-auto">
        ...
        <div className={`flex-1 flex md:flex-row flex-col ${isDarkMode ? 'bg-black' : 'bg-gray-50'}`}>
          <EmailList
            isDarkMode={isDarkMode}
