      ...
      >
        <div className="flex items-center justify-between p-4">
          <div className={`flex items-center gap-2 ${isSidebarCollapsed ? 'justify-center' : ''}`}>
            ...
            {!isSidebarCollapsed && (
              <span className={`font-semibold text-lg ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Cusana</span>
            )}
          </div>
          <button
          ...
          <div className="absolute bottom-4 left-4 right-4">
            <div className={`flex items-center gap-3 p-2 rounded-lg ${
              ...
              <div className="flex-1">
                <p className={`font-medium text-sm ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>John Smith</p>
